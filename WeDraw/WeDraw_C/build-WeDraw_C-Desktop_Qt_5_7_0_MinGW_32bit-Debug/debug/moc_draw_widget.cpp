...
#include "../../WeDraw_C/draw_widget.h"
...
const QMetaObject Draw_Widget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Draw_Widget.data,
      qt_meta_data_Draw_Widget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Draw_Widget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Draw_Widget.stringdata0))
        return static_cast<void*>(const_cast< Draw_Widget*>(this));
